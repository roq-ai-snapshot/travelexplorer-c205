...
import { getUserRecommendationById } from 'apiSdk/user-recommendations';
...
function UserRecommendationViewPage() {
  ...
  return (
    <AppLayout>
      <Text as="h1" fontSize="2xl" fontWeight="bold">
        User Recommendation Detail View
      </Text>
          ...
          <>
            ...
            {hasAccess('recommendation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
              <>
                ...
                <Text fontSize="md" as="span" ml={3}>
                  <Link as={NextLink} href={`/recommendations/view/${data?.recommendation?.id}`}>
